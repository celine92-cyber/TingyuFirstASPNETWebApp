...
var assignmentsScore = document.getElementById("assignments").value;
var groupProjectsScore = document.getElementById("groupProjects").value;
var quizzesScore = document.getElementById("quizzes").value;
var examsScore = document.getElementById("exams").value;
var intexScore = document.getElementById("intex").value;

var finalGrade = assignmentsScore * 0.5 + groupProjectsScore * 0.1 + quizzesScore * 0.1 + examsScore * 0.2 + intexScore * 0.1;
var letterGrade;
